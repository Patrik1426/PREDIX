...
function loadMapScript() {
  ...
  // If a script is already loading, return the existing promise
  if (mapScriptPromise) {
  ...
  mapScriptPromise = new Promise((resolve, reject) => {
    ...
    script.onload = () => {
      mapScriptPromise = null; // Reset promise after successful load
      resolve();
    };
    script.onerror = () => {
      mapScriptPromise = null; // Reset promise on error
